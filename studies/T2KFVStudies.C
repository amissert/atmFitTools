...
class T2KFVStudies{
  ...
  fqcutparams fqpars;
  FVStudyHistos* histos[NVOLS];  
  FVStudyHistos* histosCompare[4];  
  TCanvas* canvas;
...
//  void compareVolume(int vol1, int vol2);
